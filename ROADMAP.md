...
## Текущее состояние: v1.4.1 (2026-09-13)
...
## История релизов
- **v1.4.1** — фикс MP4/WebM: в Blender 5.2 видео переехало из
  `file_format='FFMPEG'` в `image_settings.media_type` (TypeError при
  присвоении); выбор формата в панели снова подставляет всё сам
